...
module tb_mnistTOPmlp_debug;
	...
	initial begin
		expected_label_int = 0; // default
		if ($value$plusargs("EXPECTED_LABEL=%d", expected_label_int)) begin
