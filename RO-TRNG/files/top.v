...
// ============================================================
// top.v  —  RO-TRNG NRO Sweep 버전
//
// SWEEP_EN=0: FIXED_NUM_RO 고정, SW0 토글로 1회 측정
// SWEEP_EN=1: NRO=3,5,...,51 자동 sweep, SW0으로 시작
//
// 포트:
//   clk_100m : 100MHz 클럭
//   SW0      : 측정 시작 (상승 에지)
...
module top #(
    ...
    parameter integer FIXED_NUM_RO  = 3,   // Sweep : start RO number, Sweep 아니면 고정값.
