...
module memEx(
	...
	input wire       boardclk,
	input wire[27:0] addr, //addr[0] for command
	...
	//I don't know why the original contributer utilized ui_clk_sync_rst for ready signal instead of init_calib_complete
	//However, the AMD document stated "“application has no need to wait for init_calib_complete before sending commands to the Memory Controller"
